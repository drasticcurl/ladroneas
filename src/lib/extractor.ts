...
export async function extractQuizFunnel(url: string, maxSlides = 20): Promise<ExtractionResult> {
  ...
  try {
    ...
    for (let i = 0; i < maxSlides; i++) {
      ...
      slides.push({ screenshot_base64: screenshot as string, page_text: pageText, page_html: pageHtml, url: page.url() })
